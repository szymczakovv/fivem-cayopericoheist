    ...
    CreateThread(function()
        ...
        while true do
            ...
            if Dat_2[1].val4 == false and Dat_2[2].val4 == false and Dat_2[3].val4 == false and Dat_2[4].val4 == false and Dat_2[5].val4 == false and Dat_2[6].val4 == false and Dat_2[7].val4 == false then
                ...
                Citizen.Wait(2500)
                stophack = true          
                    ESX.Scaleform.ShowFreemodeMessage('~y~Cayo Perico', 'Hakowanie ukończono pomyślnie! Twój łup z sejfu: ~o~Telefon~s~,~o~ Diamenty~s~,~o~ Złoto' , 5.0)
                    TriggerServerEvent('esx_cayoperico:itemsuccess')
                    ESX.Scaleform.ShowFreemodeMessage('~y~Cayo Perico', 'Pieniądze zostały ukryte w skrytce zamkniętej na klucz.~n~Za ~r~15~s~ sekund palnik będzie gotowy.', 15.0)
                local playerPed = Citizen.InvokeNative(0x43A66C31C68491C0, -1)
                    ...
                    ESX.Scaleform.ShowFreemodeMessage('~y~Cayo Perico', 'Rozpoczęto wypalanie zamka, do zakończenia pozostało około ~r~30~s~ sekund', 5.0)                
                    Citizen.Wait(30000)
                    Citizen.InvokeNative(0xAAA34F8A7CB32098, PlayerPedId())
                    FreezeEntityPosition(playerPed, false)
                    TriggerServerEvent('esx_cayoperico:moneysuccess')
                    ESX.Scaleform.ShowFreemodeMessage('~y~Cayo Perico', 'Wypalanie ukończono pomyślnie! Twój łup z sejfu: ~g~$200000' , 5.0)    
