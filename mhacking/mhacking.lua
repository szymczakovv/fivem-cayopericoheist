	...
	while true do
		...
		if showHelp then
			if helpTimer > GetGameTimer() then
				DisplayHelpText("Poruszaj się przy użyciu ~y~W,A,S,D~s~, zaakceptuj wybór ~y~SPACJĄ")
			elseif helpTimer > GetGameTimer()-helpCycle then
				DisplayHelpText("Poruszaj się przy użyciu ~y~Strzałek~s~, zaakceptuj wybór ~y~ENTEREM")
			else
